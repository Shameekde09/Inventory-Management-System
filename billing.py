...
#==============PRODUCT_FRAME=========================================================
        ...
        productFrame1.place(x=6,y=110,width=410,height=555)
...
#===============PRODUCT SEARCH FRAME===========================
        ...
        lbl_note=Label(productFrame1,text="Note:'Enter 0 quantity to remove from the cart",font=("goudy old style",12),anchor="w",bg="white",fg="red").pack(side=BOTTOM,fill=Y)
        ...
        lbl_p_qty=Label(add_cartwidgetsFrame,text="Quantity",font=("times new roman",15),bg="white").place(x=5,y=5)
...
#===================== FOOTET ===================================================================
        footer=Label(self.root,text="IMS-Inventory Management System | Developed By Shameek\nFor any Technical Issue Contact: 8116943490",font=("times new roman",11),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)    
        self.show()
        #self.bill_top()
...
#============================= ALL FUNCTIONS =================================================================================================================================
    ...
    def search(self):
        ...
        try:
            if self.var_search.get()=="":
                messagebox.showerror("Error","Select area should be required",parent=self.root)
            else:
    ...
    def generate_bill(self):
        if self.var_cname.get()=='' or self.var_contact.get()=='':
            ...
            messagebox.showerror("Error",f"Pease Add product to the Cart!!",parent=self.root)
        else:
            #========== BILL TOP =============
            self.bill_top()
            #========== BILL MIDDLE =============
    ...
    def bill_top(self):
        ...
        bill_top_temp=f'''
\t Presidency Hardware Emporium
\tPhone No. 8116943490, Arambagh-712601
{str("="*47)}
