...
class employeeClass:
    def __init__(self,root):
        ...
        cmb_search=ttk.Combobox(SearchFrame,textvariable=self.var_searchby,values=("Select","Email","Contact","Name"),state='readonly',justify=CENTER,font=("goudy old style",15))
