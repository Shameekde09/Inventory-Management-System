...
#========================================title=======================================================================
        ...
        scrooly=Scrollbar(sales_Frame,orient=VERTICAL)
        self.sales_List=Listbox(sales_Frame,font=("goudy old style",15),bg="white",yscrollcommand=scrooly.set)
        scrooly.pack(side=RIGHT,fill=Y)
        scrooly.config(command=self.sales_List.yview)
        ...
        scrooly2=Scrollbar(bill_Frame,orient=VERTICAL)
        self.bill_area=Text(bill_Frame,bg="lightyellow",yscrollcommand=scrooly2.set)
        scrooly2.pack(side=RIGHT,fill=Y)
        scrooly2.config(command=self.bill_area.yview)
