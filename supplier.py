...
class supplierclass:
    def __init__(self,root):
        self.root=root
        self.root.geometry("1330x600+195+130")
        ...
        txt_search=Entry(self.root,textvariable=self.var_searchtxt,font=("goudy old style",15),bg="lightyellow").place(x=800,y=80,width=200)
        btn_search=Button(self.root,text="Search",command=self.search,font=("goudy old style",15),bg="#2196f3",fg="white",cursor="hand2").place(x=1010,y=79,width=100,height=28)

        #-----------titile------------
  
        title=Label(self.root,text="Supplier Details",font=("goudy old style",20,"bold"),bg="#0f4d7d",fg="white").place(x=50,y=10,width=1240,height=40)
       ...
       #--------- BUTTONS ----------
        btn_add=Button(self.root,text="Save",command=self.add,font=("goudy old style",15),bg="#2196f3",fg="white",cursor="hand2").place(x=180,y=370,width=110,height=28)
        ...
        emp_frame.place(x=700,y=120,width=600,height=400)
